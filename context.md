...
## Files Retrieved
1. `package.json` - Tech stack: SvelteKit 5, Tailwind CSS 4, Vite, TypeScript, mdsvex.
...
5. `src/routes/+layout.ts` - `prerender = true` indicates static site generation.
...
- **Content**: Markdown-based blogging via `mdsvex`. Posts stored in `src/posts/`.
- **Routing**:
    - `/`: Home page.
    - `/about`: About page.
